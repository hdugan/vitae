%% Template for a CV
%% Author: Rob J Hyndman - Hilary Dugan
...
$if(headcolor2)$
\definecolor{headcolor2}{HTML}{$headcolor2$}
$else$
\definecolor{headcolor2}{HTML}{990000}
$endif$
...
% Horizontal Line (Dugan added so that horizontal lines go all the way across the page)
\let\oldrule=\rule
%\renewcommand{\rule}[1]{\oldrule{\linewidth}}
\renewcommand{\rule}[1]{\vspace{-9pt}\oldrule{\linewidth}}
...
\titleformat*{\subsection}{\color{headcolor2}\sf\bfseries}
...
% Make nicer bullets
\renewcommand{\labelitemi}{\ding{219}}
